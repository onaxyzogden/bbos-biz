...
export const MAQASID_PILLARS = [
  {
    ...
    accentColor: '#C8A96E',
    icon: 'BookHeart',
    subModuleIds: ['five-pillars', 'quran', 'hadith', 'islamic-knowledge', 'community-engagement', 'ethical-living'],
    status: 'active',
  ...
  },
  {
    ...
    accentColor: '#6EAD8A',
    icon: 'HeartPulse',
    subModuleIds: ['physical-wellness', 'mental-health', 'spiritual-health', 'family-health'],
    status: 'active',
  ...
  },
  {
    ...
    accentColor: '#6E8EAD',
    icon: 'Brain',
    subModuleIds: ['learning-resources', 'skill-development', 'critical-thinking', 'knowledge-sharing'],
    status: 'active',
  ...
  },
  {
    ...
    accentColor: '#AD6E9E',
    icon: 'Users',
    subModuleIds: ['family', 'neighbors', 'community', 'parenting-support', 'family-planning', 'intergenerational-support'],
    status: 'active',
  ...
  },
  {
    ...
    accentColor: '#8EAD6E',
    icon: 'Coins',
    subModuleIds: ['money', 'work', 'office', 'tech', 'people', 'financial-literacy', 'ethical-business', 'charity-zakat', 'resource-management'],
    status: 'active',
  ...
  },
  {
    ...
    accentColor: '#6EADAD',
    icon: 'TreePine',
    subModuleIds: ['sustainability', 'conservation', 'ethical-consumption', 'community-projects'],
    status: 'active',
